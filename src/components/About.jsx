        ...
        <div className="animate-in slide-in-from-bottom duration-700 delay-200">
            ...
            <div className="flex bg-gradient-to-b from-sky-700 to-indigo-950 mb-10 rounded-lg p-6 pt-10">
                ...
                <div>
                 ...
                 <img className="p-6 sm:w-1/2 w-full" src="illustrations/techwriter.png" />
                <p>During my time as a technical writer, I have taken charge of managing several documentation projects and investigating ways to make our work more efficient. This consisted automating repetitive processes, simplifying content, and improving workflows. My strong skill set and technical knowledge, combined with my eagerness to learn and improve, as well as complete the task set in front of me, make me an excellent technical writer and capable internal tool developer. </p>
            </div>
                </div>
               ...
               <div className="flex bg-gradient-to-b from-sky-700 to-indigo-950 rounded-lg p-6 pt-10 -pb-50">
                ...
                <div className="sm:bg-[url(illustrations/hiking.png)] bg-contain bg-bottom-right bg-linear-to-r from-(opacity:1) to-(opacity:0) bg-no-repeat bg-w-full min-h-100"> 
                     ...
                     <img className="w-full sm:hidden" src="illustrations\hiking.png" />
